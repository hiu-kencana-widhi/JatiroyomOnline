...
<head>
    <script>
        // Check sidebar state immediately to prevent layout shift / transition flicker
    ...
    <style>
        ...
        /* Collapsed Sidebar State (Icon-only) for Desktop */
        @media (min-width: 992px) {
            ...
            /* Initial state to prevent page load animation flash */
            ...
            html.sidebar-collapsed-init .sidebar .tracking-tight,
            html.sidebar-collapsed-init .sidebar .text-uppercase,
            html.sidebar-collapsed-init .sidebar .btn-outline-danger span {
                display: none !important;
            }
            html.sidebar-collapsed-init .sidebar .nav-sidebar .nav-link {
            ...
            html.sidebar-collapsed-init .sidebar .nav-sidebar .nav-link i {
                font-size: 1.3rem !important;
                margin-right: 0 !important;
                text-align: center !important;
                width: auto !important;
            }
            html.sidebar-collapsed-init .sidebar .mt-5 {
                margin-top: 2rem !important;
                padding: 0 !important;
            }
            html.sidebar-collapsed-init .sidebar .mt-5 form {
                width: 100%;
                display: flex;
                justify-content: center;
            }
            html.sidebar-collapsed-init .sidebar .btn-outline-danger {
                font-size: 0 !important;
            ...
            html.sidebar-collapsed-init .sidebar .btn-outline-danger i {
                margin-right: 0 !important;
                font-size: 1.2rem !important;
            }
            html.sidebar-collapsed-init .sidebar .border-bottom,
            html.sidebar-collapsed-init .sidebar .p-4.mb-3 {
                justify-content: center !important;
                padding: 1rem 0 !important;
                margin-bottom: 1rem !important;
            }
            html.sidebar-collapsed-init .sidebar .border-bottom img,
            html.sidebar-collapsed-init .sidebar .p-4.mb-3 img {
                margin-right: 0 !important;
            ...
            .sidebar.collapsed .tracking-tight,
            ...
            .sidebar.collapsed .mt-5 {
                margin-top: 2rem !important;
                padding: 0 !important;
            }
            .sidebar.collapsed .mt-5 form {
                width: 100%;
                display: flex;
                justify-content: center;
            }
            ...
            .sidebar.collapsed .p-4.mb-3 {
                justify-content: center !important;
                padding: 1rem 0 !important;
                margin-bottom: 1rem !important;
            }
            .sidebar.collapsed .border-bottom img,
            .sidebar.collapsed .p-4.mb-3 img {
                margin-right: 0 !important;
                height: 38px !important;
                width: auto !important;
            }
...
<body>
    ...
    <script>
        ...
        // Remove init class to re-enable transitions for future toggles
